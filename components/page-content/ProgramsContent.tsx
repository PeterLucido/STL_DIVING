...
<section className="story-section"><div className="wrap"><span className="story-kicker">Costs to know</span><h2>Insurance first, then choose the session flow.</h2><div className="price-grid"><div className="price-card"><b>USA Diving insurance</b><strong>$22</strong><span>Introductory Athlete 17U or AQUA Age 18+ before pool participation.</span></div><div className="price-card"><b>Monthly registration</b><strong>$35/session</strong><span>Monthly STL Diving registration through RecPlex.</span></div><div className="price-card"><b>Drop-in practice</b><strong>$40/session</strong><span>Individual drop-in practice through the RecPlex drop-in flow.</span></div></div></div></section>
